...
namespace Pronunciation.Core.Audio
{
    public class Mp3Player
    {
        ...
        {
            return Play(filePath, true, 0);
        }

        public PlaybackResult PlayFile(string filePath, float volumeDb)
        {
            return Play(filePath, true, volumeDb);
        }
        ...
        {
            return Play(rawData, false, 0);
        }

        public PlaybackResult PlayRawData(string rawData, float volumeDb)
        {
            return Play(rawData, false, volumeDb);
        }

        private PlaybackResult Play(string mp3Data, bool isFilePath, float volumeDb)
        {
